...
class ReceptacleDisplayMap extends ConsumerStatefulWidget {
  const ReceptacleDisplayMap({super.key, required this.snap});
  final Receptacle snap;

  @override
  ConsumerState<ReceptacleDisplayMap> createState() =>
      _ReceptacleDisplayMapState();
}

class _ReceptacleDisplayMapState
    extends ConsumerState<ReceptacleDisplayMap> {
  ...
  Future onMapCreated() async {
    ...
    _markers.add(
      Marker(
        ...
        infoWindow: InfoWindow(
          title: 'Receptacle',
          snippet: 'this is the location of the Receptacle',
        ),
      ),
    );
