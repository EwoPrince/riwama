...
class ClearPickup extends ConsumerStatefulWidget {
  const ClearPickup({super.key, required this.snap});
  final PickupRequest snap;
  static const routeName = '/ClearPickup';

  @override
  ConsumerState<ClearPickup> createState() => _PostBottomState();
}

class _PostBottomState extends ConsumerState<ClearPickup> {
  ...
  clearRequest(
    ...
    ref.watch(PickupRequestControllerProvider).clearRequest(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 12),
              Text(
                'Upload an Image sample of after the Pick up',
                style: Theme.of(context).textTheme.titleLarge,
                textAlign: TextAlign.center,
              ),
              image == null
