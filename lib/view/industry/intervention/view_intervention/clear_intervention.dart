...
class ClearIntervention extends ConsumerStatefulWidget {
  const ClearIntervention({super.key, required this.snap});
  final Interventionrequest snap;
  static const routeName = '/ClearIntervention';

  @override
  ConsumerState<ClearIntervention> createState() => _PostBottomState();
}

class _PostBottomState extends ConsumerState<ClearIntervention> {
  ...
  clearRequest(
    ...
    ref.watch(InterventionRequestControllerProvider).clearIntervention(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              SizedBox(height: 12),
              Text(
                'Provide the following to resolve this Interevention Request',
                style: Theme.of(context).textTheme.titleLarge,
                textAlign: TextAlign.center,
              ),
              SizedBox(height: 12),
              Text(
                'Upload an Image sample of after the intervention',
                style: Theme.of(context).textTheme.titleLarge,
                textAlign: TextAlign.center,
              ),
              image == null
