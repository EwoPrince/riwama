...
class InterventionDisplaySection extends ConsumerStatefulWidget {
  const InterventionDisplaySection({super.key, required this.snap});
  final Interventionrequest snap;

  @override
  ConsumerState<InterventionDisplaySection> createState() =>
      _InterventionDisplaySectionState();
}

class _InterventionDisplaySectionState
    extends ConsumerState<InterventionDisplaySection> {
  ...
  Future onMapCreated() async {
    ...
    _markers.add(
      Marker(
        ...
        infoWindow: InfoWindow(
          title: 'Intervention',
          snippet: 'this is the location of the intervention',
        ),
      ),
    );
