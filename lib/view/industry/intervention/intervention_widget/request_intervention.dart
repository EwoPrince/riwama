...
void InterventionModalBottomSheet(
  ...
  showModalBottomSheet(
    ...
    builder: (BuildContext context) {
      ...
      Future sendRequestIntervention(
        String lon,
        String lat,
      ) async {
        await ref
            .read(InterventionRequestControllerProvider)
            ...
            : Container(
                ...
                child: Column(
                  ...
                  children: [
                    SizedBox(height: 12),
                    Text(
                      'Location for this Intervention?',
                      style: TextStyle(
                        fontSize: 16,
