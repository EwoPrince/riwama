...
class SampleSelect extends ConsumerStatefulWidget {
  static const routeName = '/SampleSelect';
  @override
  _SampleSelectState createState() => _SampleSelectState();
}

class _SampleSelectState extends ConsumerState<SampleSelect> {
  File? image;
    ...
    return Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Upload an Image sample for this intervention',
