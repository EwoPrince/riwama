...
import 'package:riwama/view/industry/intervention/intervention_widget/crop_editor.dart';
import 'package:riwama/view/industry/intervention/intervention_widget/edit_tools.dart';
import 'package:riwama/widgets/button.dart';
import 'package:riwama/widgets/loading.dart';
import 'package:riwama/x.dart';

class EditChatImage extends ConsumerStatefulWidget {
  const EditChatImage({
    super.key,
    required this.file,
  ...
  static const routeName = '/EditChatImage';

  @override
  ConsumerState<EditChatImage> createState() => _EditImageState();
}

class _EditImageState extends ConsumerState<EditChatImage> {
